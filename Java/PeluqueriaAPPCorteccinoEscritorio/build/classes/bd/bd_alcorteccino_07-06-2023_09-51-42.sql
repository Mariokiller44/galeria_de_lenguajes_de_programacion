...
--
-- Host: localhost    Database: bd_alcorteccino
-- ------------------------------------------------------
...
INSERT INTO `cita` VALUES (1,3,1),(10,16,19),(11,15,2),(26,3,23),(29,2,18),(30,3,22),(49,3,27),(54,42,35),(55,42,33);
...
INSERT INTO `horario` VALUES (1,'2023-06-01','05:50:59','01-06-2023','05:50:59',7,4),(2,'2023-05-31','13:30:00','31-05-2023','13:30:00',8,3),(18,'2023-05-31','11:30:00','31-05-2023','11:30:00',8,5),(19,'2023-05-31','14:30:00','31-05-2023','14:30:00',12,3),(20,'2023-06-05','11:00:00','05-06-2023','11:00:00',5,3),(21,'2023-06-08','13:00:00','08-06-2023','13:00:00',8,1),(22,'2023-06-08','12:00:00','08-06-2023','12:00:00',8,5),(23,'2023-06-12','18:30:00','12-06-2023','18:30:00',8,3),(24,'2023-06-06','12:30:00','06-06-2023','12:30:00',7,3),(25,'2023-06-07','16:00:00','07-06-2023','16:00:00',7,2),(27,'2023-06-05','18:00:00','05-06-2023','18:00:00',8,3),(29,'2023-06-07','11:30:00','07-06-2023','11:30:00',31,3),(31,'2023-06-15','14:30:00','15-06-2023','14:30:00',8,2),(32,'2023-06-20','17:00:00','20-06-2023','17:00:00',10,2),(33,'2023-06-23','18:00:00','23-06-2023','18:00:00',6,5),(34,'2023-06-26','11:00:00','26-06-2023','11:00:00',5,2),(35,'2023-06-15','12:30:00','15-06-2023','12:30:00',10,5);
...
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`admin`@`localhost`*/ /*!50003 TRIGGER `actualizar_fecha_horarios` BEFORE INSERT ON `horario` FOR EACH ROW BEGIN
    IF NEW.fecha < CURDATE() THEN
        SET NEW.fecha = DATE_ADD(CURDATE(), INTERVAL 7 DAY);
    END IF;
END */;;
DELIMITER ;
...
/*!50003 SET sql_mode              = 'NO_AUTO_VALUE_ON_ZERO' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`admin`@`localhost`*/ /*!50003 TRIGGER `control_fecha_insert` BEFORE INSERT ON `horario` FOR EACH ROW BEGIN
    IF NEW.fecha < CURDATE() THEN
        SIGNAL SQLSTATE '45000'
        SET MESSAGE_TEXT = 'No se puede insertar un horario con fecha anterior a hoy';
    END IF;
END */;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
...
/*!50003 SET sql_mode              = 'NO_AUTO_VALUE_ON_ZERO' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`admin`@`localhost`*/ /*!50003 TRIGGER `mantener_horarios_semana` BEFORE INSERT ON `horario` FOR EACH ROW BEGIN
    ...
    SELECT hora INTO hora_asignada
...
INSERT INTO `productos` VALUES (1,'Peine',20),(2,'Maquina de cortar el pelo',22),(3,'Champú',63),(4,'Gelacondicionador',40),(5,'Secadora',9),(6,'Tinterojo',10),(7,'Tintenegro',40),(8,'Tintemarron',35),(11,'Laca',20),(12,'Lima',20);
...
/*!50003 SET sql_mode              = 'NO_AUTO_VALUE_ON_ZERO' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`admin`@`localhost`*/ /*!50003 TRIGGER `codificar_md5` BEFORE INSERT ON `usuario` FOR EACH ROW BEGIN
...
/*!50003 SET sql_mode              = 'NO_AUTO_VALUE_ON_ZERO' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`admin`@`localhost`*/ /*!50003 TRIGGER `insertar_usuario` AFTER INSERT ON `usuario` FOR EACH ROW BEGIN
...
-- Dump completed on 2023-06-07  9:51:42
