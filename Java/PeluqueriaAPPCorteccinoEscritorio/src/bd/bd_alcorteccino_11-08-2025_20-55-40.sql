...
INSERT INTO `cliente` VALUES (2,'Soy un seleccionador calvo'),(3,'Soy papadopoulos'),(4,'Soy un fontanero mayor'),(16,'Soy un piloto que conseguirá la 33'),(17,'Soy un cabron '),(32,'pequeño enrea'),(37,'Jugador argentino'),(41,'maduro casado'),(42,'Los molinos man dao pal pelo');
...
INSERT INTO `horario` (`ID`, `FECHA`, `HORA`, `ID_PERSONAL`, `ID_SERVICIO`) VALUES (1,'2026-03-01','05:50:59',7,4),(2,'2026-02-28','13:30:00',8,3),(18,'2025-10-14','18:00:00',7,2),(19,'2026-02-28','14:30:00',12,3),(20,'2026-03-05','11:00:00',5,3),(21,'2026-03-08','13:00:00',8,1),(22,'2026-03-08','12:00:00',8,5),(23,'2026-03-12','18:30:00',8,3),(24,'2026-03-06','12:30:00',7,3),(25,'2026-03-07','16:00:00',7,2),(27,'2026-03-05','18:00:00',8,3),(29,'2026-03-07','11:30:00',31,3),(31,'2026-03-15','14:30:00',8,2),(32,'2026-03-20','17:00:00',10,2),(33,'2026-03-23','18:00:00',6,5),(34,'2026-03-26','11:00:00',5,2),(35,'2026-03-15','12:30:00',10,5),(38,'2026-01-19','11:30:00',7,4),(41,'2025-09-09','09:30:00',5,6);
...
--
-- Temporary view structure for view `vista_horario_detallado`
--

DROP TABLE IF EXISTS `vista_horario_detallado`;
/*!50001 DROP VIEW IF EXISTS `vista_horario_detallado`*/;
SET @saved_cs_client     = @@character_set_client;
/*!50503 SET character_set_client = utf8mb4 */;
/*!50001 CREATE VIEW `vista_horario_detallado` AS SELECT 
 1 AS `id_horario`,
 1 AS `fecha`,
 1 AS `hora`,
 1 AS `servicio`,
...
--
-- Final view structure for view `vista_horario_detallado`
--
...
/*!50001 VIEW `vista_horario_detallado` AS select `h`.`ID` AS `id_horario`,`h`.`FECHA` AS `fecha`,`h`.`HORA` AS `hora`,`s`.`DESCRIPCION` AS `servicio`,coalesce(concat(`u`.`NOMBRE`,' ',`u`.`APELLIDOS`),'Disponible') AS `cliente`,coalesce(concat(`u2`.`NOMBRE`,' ',`u2`.`APELLIDOS`),'Sin asignar') AS `personal` from ((((((`horario` `h` left join `cita` `c` on(`h`.`ID` = `c`.`ID_HORARIO`)) left join `servicios` `s` on(`h`.`ID_SERVICIO` = `s`.`ID`)) left join `cliente` `cli` on(`c`.`ID_CLIENTE` = `cli`.`ID`)) left join `usuario` `u` on(`cli`.`ID` = `u`.`ID`)) left join `personal` `per` on(`h`.`ID_PERSONAL` = `per`.`ID`)) left join `usuario` `u2` on(`per`.`ID` = `u2`.`ID`)) */;
...
-- Dump completed on 2025-08-11 20:55:48
